                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="año = 2015"><p style="color:red"> <xsl:value-of select="año"/></p>  </xsl:when>
                                    <xsl:when test="año = 2020"><p style="color:green"> <xsl:value-of select="año"/></p>  </xsl:when>
